  <footer>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-7">
          <ul class="footer-nav">
            <li><a href="#info">Ture - Informacije</a></li>
  ...
  <div class="overlay overlay-boxify">
    <nav>
      <ul>
        <li><a href="#info"><i class="fa fa-ship"></i>Ture - Informacije</a></li>
        <li><a href="#about-us"><i class="fa fa-info"></i>O nama</a></li>
      </ul>
      <ul>
        <li><a href="#gallery"><i class="fa fa-picture-o"></i>Galerija</a></li>
        <li><a href="#contact"><i class="fa fa-envelope-o"></i>Kontakt</a></li>
      </ul>
      <ul>
